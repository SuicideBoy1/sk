...
if (message.channel.id == '480879077600002049') {
    message.react("${bot.emojis.get(emojis.yes)}")
    message.react("${bot.emojis.get(emojis.no)}");
}
